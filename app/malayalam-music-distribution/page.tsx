...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://westernbeats.com/malayalam-music-distribution' },
  openGraph: {
    ...
    url: 'https://westernbeats.com/malayalam-music-distribution',
  ...
  '@graph': [
    {
      ...
      breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Malayalam Music Distribution', item: 'https://westernbeats.com/malayalam-music-distribution' },
      ]},
    },
    {
      '@type': 'FAQPage',
