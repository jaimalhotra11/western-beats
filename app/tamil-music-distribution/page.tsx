...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.westernbeats.com/tamil-music-distribution' },
  openGraph: {
    ...
    url: 'https://www.westernbeats.com/tamil-music-distribution',
  ...
  '@graph': [
    {
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Tamil Music Distribution', item: 'https://www.westernbeats.com/tamil-music-distribution' },
        ],
      },
    },
    {
