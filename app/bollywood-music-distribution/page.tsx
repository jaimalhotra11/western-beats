...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://westernbeats.com/bollywood-music-distribution' },
  openGraph: {
    title: 'Bollywood Music Distribution India — Distribute Hindi Film Songs Free | Western Beats',
    ...
    url: 'https://westernbeats.com/bollywood-music-distribution',
  ...
  '@graph': [
    {
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Hindi Music Distribution', item: 'https://westernbeats.com/hindi-music-distribution' },
          { '@type': 'ListItem', position: 3, name: 'Bollywood Music Distribution', item: 'https://westernbeats.com/bollywood-music-distribution' },
        ],
      },
    },
    {
