...
export const metadata: Metadata = {
  ...
  description:
    'WB Digital music distribution is 100% free — ₹0 upfront forever. You earn 70% of every stream, we take 30% only when you earn. Compare vs DistroKid ($22.99/yr), TuneCore ($14.99/release), CD Baby ($9.99 + 9%), Ditto Music, and Believe. Best value for Indian artists.',
  keywords: [
    'WB Digital pricing',
    ...
    'music distribution free 70 percent royalties',
    ...
    'music royalties 70 percent India',
  ...
  openGraph: {
    ...
    description: '₹0 forever. 70% royalties to you. No annual fee, no per-release charge. We only earn when you earn. Compare vs DistroKid, TuneCore & CD Baby.',
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Free music distribution to 150+ streaming platforms. 70% royalties to artist, 30% to WB Digital — only when you earn. Zero upfront cost. Warner Music India backed.',
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. WB Digital music distribution is ₹0 upfront, forever. No annual fee, no per-release charge. WB Digital earns a 30% revenue share only when you earn — you keep 70% of every stream. We only make money when you make money.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'DistroKid costs $22.99/year (₹1,900+) for unlimited releases. WB Digital costs ₹0 upfront. WB Digital takes 30% of royalties only when you earn; DistroKid keeps 0% but charges the annual fee. For artists earning under ~₹6,333/month from streaming, WB Digital is more cost-effective.',
          },
        },
      ],
    },
