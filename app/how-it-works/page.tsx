...
export const metadata: Metadata = {
  ...
  description:
    'See exactly how WB Digital works: Submit your music → We distribute to 150+ platforms in 48-72 hours → You earn 70% of net royalties (100% IP ownership yours). Free forever. Backed by Warner Music India. Faster than DistroKid, TuneCore & CD Baby.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Submit → Distribute to 150+ platforms in 48 hrs → Keep 70% royalties. Free forever. Backed by Warner Music India.',
  ...
  twitter: {
    ...
    description: '3 simple steps. 150+ platforms. 48 hours. 70% royalties to you. Free forever.',
    site: '@wb_digital_',
  },
}
  ...
  '@graph': [
    ...
    },
    {
      ...
      step: [
        ...
        { '@type': 'HowToStep', position: 3, name: 'Earn 70% Royalties', text: '70% of all net streaming royalties flow directly to you. WB retains 30% as a Distribution Fee only when you earn — zero upfront cost.' },
      ],
    },
  ],
}
