...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://westernbeats.com/bengali-music-distribution' },
  openGraph: {
    ...
    url: 'https://westernbeats.com/bengali-music-distribution',
  ...
  '@graph': [
    {
      ...
      breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Bengali Music Distribution', item: 'https://westernbeats.com/bengali-music-distribution' },
      ]},
    },
    {
      '@type': 'FAQPage',
