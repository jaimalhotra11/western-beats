...
const MENTIONS = [
  {
    ...
    excerpt: 'The Haryana-based music company has quietly become the go-to distribution platform for independent artists in India, offering free distribution and a 80/20 royalty split that is hard to beat.',
    color: '#0A64C3',
  },
  {
    outlet: 'Forbes India',
