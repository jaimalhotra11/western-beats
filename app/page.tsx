...
export const metadata: Metadata = {
  ...
  description:
    ...
    "Earn 70% royalties on every stream — we only take 30% when you earn. Better than DistroKid, TuneCore, CD Baby, Ditto Music & Believe.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "India's most credible full-service music company. Free distribution via WB Digital to 150+ platforms. Warner Music India backed. Earn 70% royalties on every stream.",
