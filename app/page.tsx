...
export const metadata: Metadata = {
  ...
  description:
    ...
    "Keep 70% royalties on every stream (100% IP ownership always yours, T&C apply). Better than DistroKid, TuneCore, CD Baby, Ditto Music & Believe.",
  keywords: [
    ...
    '70% royalties music distribution India', 'free music distribution 150 platforms',
  ...
  openGraph: {
    ...
    description: "India's most credible full-service music company. Free distribution via WB Digital to 150+ platforms. Warner Music India backed. Keep 70% royalties on every stream.",
  ...
  twitter: {
    ...
    description: "Free music distribution to 150+ platforms. Warner Music India backed. 70% royalties to you. India's best.",
    site: '@wb_digital_',
  },
}
