...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://westernbeats.com/blog/spotify-royalties-india-2026' },
  openGraph: {
    title: 'Spotify Royalties India 2026 — How Much Does Spotify Pay Per Stream? | Western Beats',
    ...
    url: 'https://westernbeats.com/blog/spotify-royalties-india-2026',
  ...
  '@graph': [
    {
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Spotify Royalties India 2026', item: 'https://westernbeats.com/blog/spotify-royalties-india-2026' },
        ],
      },
    },
    {
