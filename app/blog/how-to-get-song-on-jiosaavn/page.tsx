...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://westernbeats.com/blog/how-to-get-song-on-jiosaavn' },
  openGraph: {
    ...
    url: 'https://westernbeats.com/blog/how-to-get-song-on-jiosaavn',
  ...
  '@graph': [
    {
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'How to Get Song on JioSaavn', item: 'https://westernbeats.com/blog/how-to-get-song-on-jiosaavn' },
        ],
      },
    },
    {
