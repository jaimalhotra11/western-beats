...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://westernbeats.com/blog/best-music-distributors-india-2026' },
  openGraph: {
    ...
    url: 'https://westernbeats.com/blog/best-music-distributors-india-2026',
  ...
  '@graph': [
    {
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Best Music Distributors India 2026', item: 'https://westernbeats.com/blog/best-music-distributors-india-2026' },
        ],
      },
    },
    {
