...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.westernbeats.com/blog/how-to-make-money-from-music-india' },
  openGraph: {
    title: 'How to Make Money from Music in India 2026 — 8 Real Revenue Streams | Western Beats',
    ...
    url: 'https://www.westernbeats.com/blog/how-to-make-money-from-music-india',
  ...
  '@graph': [
    {
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'How to Make Money from Music India', item: 'https://www.westernbeats.com/blog/how-to-make-money-from-music-india' },
        ],
      },
    },
    {
