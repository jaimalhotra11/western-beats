...
const POSTS = [
  ...
  {
    slug: 'how-to-get-song-on-jiosaavn',
    title: 'How to Get Your Song on JioSaavn India 2026 — Free Step-by-Step Guide',
    excerpt: 'Complete guide to getting your song on JioSaavn India. Exact 5-step submission process, what JioSaavn pays per stream, how to pitch to editorial playlists, and why most global distributors miss JioSaavn entirely.',
    tag: 'JioSaavn Guide',
    color: '#0A64C3',
    readTime: '8 min read',
    date: 'July 2026',
  ...
  {
    slug: 'best-music-distributors-india-2026',
    title: 'Best Music Distributors India 2026 — Ranked & Compared (Free vs Paid)',
    excerpt: 'Full ranked comparison of Western Beats vs DistroKid vs TuneCore vs CD Baby vs Deliver My Tune for Indian artists. Based on JioSaavn coverage, cost, caller tune support, and Warner Music India Partnership.',
    tag: 'Comparison',
    color: '#C41230',
    readTime: '9 min read',
    date: 'July 2026',
  ...
  {
    slug: 'spotify-royalties-india-2026',
    title: 'Spotify Royalties India 2026 — How Much Does Spotify Pay Per Stream?',
    excerpt: 'Exact Spotify royalty rates for India in 2026 vs JioSaavn, Gaana, Apple Music and Jio Caller Tune. Full earnings table by stream count and tips to maximise your streaming income as an independent artist.',
    tag: 'Royalties',
    color: '#1DB954',
    readTime: '7 min read',
    date: 'July 2026',
  ...
  {
    slug: 'music-distribution-guide-hindi',
    title: 'Hindi Music Distribution India 2026 — Complete Guide for Independent Artists',
    excerpt: 'Everything independent Hindi artists need to know about music distribution in 2026: which platforms matter most, how to get on JioSaavn, Gaana and Jio Caller Tune, and how to earn from Hindi music streaming.',
    tag: 'Hindi Music Guide',
    color: '#0A64C3',
    readTime: '10 min read',
    date: 'July 2026',
  },
  {
    slug: 'how-to-make-money-from-music-india',
    title: 'How to Make Money from Music in India 2026 — 8 Real Revenue Streams',
    excerpt: 'All 8 ways Indian independent artists can earn money from music: streaming royalties, Jio Caller Tune CRBT, YouTube Content ID, sync licensing, live shows, brand deals, merch, and teaching — with real earning estimates.',
    tag: 'Income Guide',
    color: '#0A64C3',
  ...
  {
    slug: 'distrokid-vs-tunecore-vs-western-beats',
    title: 'DistroKid vs TuneCore vs Western Beats 2026 — Best for Indian Artists',
    excerpt: 'Honest comparison of DistroKid, TuneCore and Western Beats for Indian artists. Which is free? Which has JioSaavn? Which gives 100% royalties? The definitive answer.',
    tag: 'Comparison',
    color: '#F59E0B',
    readTime: '8 min read',
    date: 'July 2026',
  ...
  {
    slug: 'free-music-distribution-no-fees-india',
    title: 'Free Music Distribution in India With No Hidden Fees 2026',
    excerpt: 'Most "free" distributors have annual fees, per-release charges, or commission cuts. Learn to spot the hidden costs and find the one truly free music distributor in India.',
    tag: 'Distribution Guide',
    color: '#34D399',
    readTime: '6 min read',
    date: 'July 2026',
  ...
  {
    slug: 'how-to-get-isrc-code-free-india',
    title: 'How to Get a Free ISRC Code in India in 2026',
    excerpt: 'ISRC codes are required by every streaming platform. Here\'s exactly what they are, why you need one for JioSaavn and Spotify, and how to get yours free in under 5 minutes.',
    tag: 'ISRC Guide',
    color: '#5CB2DC',
    readTime: '5 min read',
    date: 'July 2026',
  ...
  {
    slug: 'youtube-music-royalties-india-2026',
    title: 'YouTube Music Royalties India 2026 — How Much Do You Really Earn?',
    excerpt: 'Per-stream rates, Content ID income, premium vs free listener differences — everything Indian artists need to know about YouTube Music earnings in 2026.',
    tag: 'Royalties',
    color: '#EF4444',
    readTime: '7 min read',
    date: 'July 2026',
  ...
  {
    slug: 'music-distribution-mistakes-to-avoid-india',
    title: '10 Music Distribution Mistakes Indian Artists Make in 2026',
    excerpt: 'From choosing a distributor without JioSaavn to skipping caller tunes and ignoring ISRC codes — these 10 mistakes are costing Indian artists thousands of rupees in lost royalties every month.',
    tag: 'Must Read',
    color: '#F87171',
    readTime: '9 min read',
    date: 'July 2026',
  ...
  {
    slug: 'how-to-get-on-spotify-playlists-india',
    title: 'How to Get on Spotify Playlists India 2026 — Complete Guide',
    excerpt: 'Step-by-step guide to editorial pitching, algorithmic playlists (Release Radar, Discover Weekly), and user-curated playlists on Spotify India. Includes the top Indian playlists to target.',
    tag: 'Spotify Guide',
    color: '#1DB954',
    readTime: '9 min read',
    date: 'August 2026',
  ...
  {
    slug: 'how-to-get-on-jiosaavn-playlists',
    title: 'How to Get on JioSaavn Playlists 2026 — The Guide Nobody Else Covers',
    excerpt: 'JioSaavn has 310M users but no public pitching portal. This guide reveals how editorial playlist placement works at JioSaavn and how Western Beats pitches on behalf of artists.',
    tag: 'JioSaavn Guide',
    color: '#0A64C3',
    readTime: '8 min read',
    date: 'August 2026',
  ...
  {
    slug: 'cover-art-size-dimensions-music-distribution',
    title: 'Cover Art Size & Dimensions for Music Distribution 2026 — Full Spec Guide',
    excerpt: 'Exact artwork specifications for Spotify, JioSaavn, Apple Music, Amazon Music, Gaana and all platforms. Common rejection reasons, design tips, and free tools.',
  ...
  {
    slug: 'how-to-get-first-1000-streams-spotify-india',
    title: 'How to Get Your First 1,000 Streams on Spotify India 2026',
    excerpt: 'The 5-week playbook for Indian independent artists to hit 1,000 Spotify streams on release week — WhatsApp strategy, editorial pitching, pre-save campaigns and more.',
    tag: 'Strategy Guide',
    color: '#34D399',
    readTime: '8 min read',
    date: 'August 2026',
  ...
  {
    slug: 'wav-vs-mp3-audio-format-music-distribution',
    title: 'WAV vs MP3 for Music Distribution India 2026 — Which Format to Use?',
    excerpt: 'Should you upload WAV or MP3? Exact platform requirements for Spotify, JioSaavn, Apple Music, Gaana — bit depth, sample rate, and the most common mistakes Indian artists make.',
    tag: 'Technical Guide',
    color: '#5CB2DC',
    readTime: '7 min read',
    date: 'August 2026',
  ...
  {
    slug: 'tiktok-for-musicians-india-2026',
    title: 'TikTok for Musicians India 2026 — Complete Growth Guide',
    excerpt: 'How Indian artists go viral on TikTok and convert that into Spotify and JioSaavn streams. Content strategy, best posting times, and how to get your song into TikTok\'s sound library.',
    tag: 'Social Media',
    color: '#F59E0B',
    readTime: '8 min read',
    date: 'August 2026',
  ...
  {
    slug: 'music-publishing-india-guide',
    title: 'Music Publishing India 2026 — Complete Guide (IPRS, Royalties & More)',
    excerpt: 'What is music publishing in India, how IPRS collects performance royalties, how to register, and whether you need a publisher — everything independent Indian artists need to know.',
    tag: 'Rights & Publishing',
    color: '#A78BFA',
    readTime: '10 min read',
    date: 'August 2026',
  },
  {
    slug: 'streaming-fraud-india-how-to-avoid',
    title: 'Streaming Fraud India — What It Is and How to Avoid Getting Banned',
    excerpt: 'Fake streams, bot services and click farms are permanently banning Indian artists from Spotify and JioSaavn. Learn what counts as fraud and what legitimate promotion looks like.',
    tag: '⚠️ Warning',
    color: '#EF4444',
    readTime: '7 min read',
    date: 'August 2026',
