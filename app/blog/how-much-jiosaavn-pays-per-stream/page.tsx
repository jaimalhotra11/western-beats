...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://westernbeats.com/blog/how-much-jiosaavn-pays-per-stream' },
  openGraph: {
    ...
    url: 'https://westernbeats.com/blog/how-much-jiosaavn-pays-per-stream',
...
const ARTICLE_SCHEMA = {
  ...
  breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'JioSaavn Pay Per Stream', item: 'https://westernbeats.com/blog/how-much-jiosaavn-pays-per-stream' },
  ]},
}
