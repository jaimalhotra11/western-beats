...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://westernbeats.com/blog/caller-tune-crbt-distribution-india' },
  openGraph: {
    ...
    url: 'https://westernbeats.com/blog/caller-tune-crbt-distribution-india',
