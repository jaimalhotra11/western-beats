...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://westernbeats.com/blog/music-distribution-guide-hindi' },
  openGraph: {
    ...
    url: 'https://westernbeats.com/blog/music-distribution-guide-hindi',
  ...
  '@graph': [
    {
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Hindi Music Distribution Guide 2026', item: 'https://westernbeats.com/blog/music-distribution-guide-hindi' },
        ],
      },
    },
    {
