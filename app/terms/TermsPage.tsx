...
const ARTICLES = [
  ...
  },
  {
    ...
    paras: [
      'AI-GENERATED CONTENT — ZERO TOLERANCE: Western Beats does not accept, distribute, or monetise any Content that is wholly or materially generated, composed, performed, or produced using artificial intelligence tools, including but not limited to Suno, Udio, Boomy, Soundful, Aiva, Mubert, or any other AI music generator. The Licensor expressly warrants that all Content submitted under this Agreement is 100% human-created.',
      'PROHIBITION ON EXPLOITING AI VERSIONS OF ARTISTS: Nothing in this Agreement permits the Licensee to create or commercially exploit any synthetic, AI-generated, digitally replicated, or digitally manipulated version of any artist\'s voice, likeness, image, or persona embodied in the Content, except with the Licensor\'s prior written approval and subject to the Licensor having obtained all necessary artist and third-party consents. For the avoidance of doubt, standard editing, resizing, formatting, encoding, restoration, subtitling, dubbing, localisation, metadata processing, quality control, promotional editing, and preparation of platform-compliant versions of the Content in accordance with this Agreement shall not be restricted.',
      'LICENSOR\'S OBLIGATION TO DISCLOSE: The Licensor shall not deliver any Content or Licensed Properties that are wholly or materially AI-generated, synthetically created, digitally replicated, or digitally manipulated without prior written disclosure to and approval of the Licensee, and unless the Licensor has obtained all rights, permissions, releases, and consents necessary for the distribution and exploitation of such Content or Licensed Properties under this Agreement. Breach of this clause constitutes an immediate Event of Default and the Licensee may reject and remove such Content without liability and withhold all associated revenue.',
      'PROHIBITION ON AI MODEL TRAINING: Neither Party shall use the other Party\'s Content, Licensed Properties, confidential information, proprietary materials, or data to train, fine-tune, or develop any generative artificial intelligence model without the other Party\'s prior written consent. Any such use without consent shall constitute a material breach of this Agreement and entitle the non-defaulting Party to seek damages and immediate termination.',
      'CONSEQUENCES OF AI VIOLATION: In the event the Licensor submits AI-generated Content in breach of this Agreement: (a) the Licensee may immediately remove the Content from all platforms without notice; (b) all revenue generated by the infringing Content shall be forfeited and retained by the Licensee; (c) the Licensee may terminate this Agreement with immediate effect; and (d) the Licensor shall indemnify the Licensee for all losses, costs, and damages arising from the submission of such Content.',
    ],
  },
  {
    id: 'representations',
