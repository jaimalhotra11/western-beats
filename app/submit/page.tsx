...
export const metadata: Metadata = {
  ...
  description:
    'Submit your music to WB Digital for free distribution to 150+ streaming platforms — JioSaavn, Gaana, Spotify, Apple Music & more. Go live in 48 hours. Earn 70% royalties. Backed by Warner Music India. Start today — ₹0 upfront.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Submit your music for free distribution to 150+ platforms in 48 hours. 70% royalties. Warner Music India backed. ₹0 upfront.',
  ...
  twitter: {
    ...
    description: '150+ platforms in 48 hours. 70% royalties. Free forever. Backed by Warner Music India.',
    site: '@wb_digital_',
  },
}
