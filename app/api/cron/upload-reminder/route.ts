...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Find users who signed up within the last 30 days
    ...
    // Get all emails that have at least one submission
    ...
    // Filter to users who haven't submitted yet
              ...
              <tr><td align="center">
                <table width="560" cellpadding="0" cellspacing="0" style="background:#060C18;border-radius:20px;border:1px solid rgba(255,255,255,0.08);overflow:hidden;max-width:560px;width:100%;">
                  ...
                  <tr><td style="padding:36px 40px;">
                    ...
                    <a href="https://www.westernbeats.com/submit" style="display:inline-block;background:#0A64C3;color:#fff;padding:15px 36px;border-radius:12px;text-decoration:none;font-weight:700;font-size:15px;letter-spacing:0.02em;">Upload Your Music Now →</a>

                    <p style="color:#4A5568;font-size:13px;line-height:1.6;margin:28px 0 0;">
                      Questions? Reply to this email or reach us at <a href="mailto:legal@westernbeats.com" style="color:#5CB2DC;">legal@westernbeats.com</a>
                    </p>
