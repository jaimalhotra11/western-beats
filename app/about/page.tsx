...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "About Western Beats: India's #1 Free Music Distribution | Backed by Warner Music India",
    description:
      "Discover why independent artists choose Western Beats. 100% FREE distribution to 150+ platforms. 100% ownership, royalties paid directly to you. Officially backed by Warner Music India. The best alternative to DistroKid, TuneCore & CD Baby for Indian artists.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Western Beats: India's #1 Free Music Distribution Platform Backed by Warner Music India",
      },
    ],
  },
  twitter: {
...
const jsonLd = {
  ...
  '@graph': [
    ...
    /* WebPage */
    {
      ...
      description:
        "Learn about Western Beats Private Limited, India's most trusted free music distribution platform, officially backed by Warner Music India.",
    ...
    /* FAQPage: targets featured snippets & competitor comparison searches */
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes! Western Beats distributes to JioSaavn, Gaana, and all major Indian platforms, along with Spotify, Apple Music, YouTube Music, Amazon Music, and 140+ more global platforms. Being backed by Warner Music India gives Western Beats priority placement on Indian platforms, something no other distributor like DistroKid or TuneCore can offer.',
          },
        },
        {
          '@type': 'Question',
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Beyond free music distribution, Western Beats offers Event Management, Talent Management, Audio Production, Video Direction, and Analytics & Strategy services. We are a full-service music company backed by Warner Music India, giving independent artists access to major-label resources without major-label restrictions.',
          },
        },
      ],
    },
