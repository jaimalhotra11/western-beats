...
export const metadata: Metadata = {
  title: 'Best Music Distributor for Australian Artists 2026 — Free, 150+ Platforms | Western Beats',
  description: 'Western Beats distributes music for Australia-based independent artists to Spotify, Apple Music, Amazon Music, YouTube Music and 150+ platforms — free, with 100% ownership and no annual fee.',
  keywords: [
